@include('template1/common/header')
@include('template1/common/topbar')
...
<div class="dashboard-container">
    ...
    <div class="container">
        <!-- Top Nav Start -->
        @include("template1/common/top_navigation")
        <!-- Top Nav End -->
        ...
        <div class="dashboard-wrapper-lg">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="mini-widget">
                        <div class="mini-widget-heading clearfix">
                            <div class="pull-left">Total Employee </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="mini-widget">
                        <div class="mini-widget-heading clearfix">
                            <div class="pull-left">Todays Effort</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="mini-widget mini-widget-grey">
                        <div class="mini-widget-heading clearfix">
                            <div class="pull-left">Users Online</div>
...
@include('template1/common/footer')